...
export default function ChatPage(): React.JSX.Element {
        ...
        <section className="relative z-10 w-full max-w-xl animate-fade-in-up space-y-5">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="rounded-xl border border-zinc-700 px-5 py-3 text-sm font-medium text-zinc-300 hover:border-zinc-500"
            >
              ← Back
            </button>
            <button
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0a0a0a] px-6 text-zinc-100">
      ...
      <section className="relative z-10 w-full max-w-3xl animate-fade-in-up space-y-8 text-center">
        <div>
